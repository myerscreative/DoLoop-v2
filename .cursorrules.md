...
## Core Concept - "The Second Self"

DoLoop is a "Second Self" framework—calm, organized, and expensive-feeling. It is a "cookbook of success recipes" (Loops) that helps users build momentum.

- **"Focus & Fade":** The active task is the visual anchor; others are dimmed.
- **"Three-Tap" Rule:** No core action should take more than three taps.
- **"Spatial Consistency":** Center is NOW, Swipe Down is HISTORY, Swipe Up is FUTURE.
- **"Sensory Feedback":** Kinetic design with Gold Pulses and Haptic feedback.
...
### Visual Identity (Premium Vibrant)

1. **The Momentum Ring** - A thin, glowing thread of Gold (#FEC00F).
2. **Deep Charcoal Aesthetic** - Background is near-black charcoal; surfaces use Glassmorphism.
3. **Focus Mode** - Active step is 100% white; others are 40% grey.
4. **Info-Drop & Provenance** - Every loop has a "Why" (Info-Drop) and a "Who" (Provenance).

### Color Palette

```typescript
const colors = {
  // Brand (Premium Vibrant)
  primary: "#FEC00F", // Momentum Gold
