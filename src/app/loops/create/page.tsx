  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        >
          {/* Three circular arrows forming a loop */}
          <path
          ...
          />
          {/* Plus sign in center */}
          <rect x="210.78" y="146.63" width="18.61" height="164.81" fill="black"/>
          <rect x="210.78" y="146.63" width="18.61" height="164.81" fill="black" transform="translate(449.12 8.96) rotate(90)"/>
        </svg>
      </motion.button>
    </div>
  );
